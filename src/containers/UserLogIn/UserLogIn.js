      ...
      <div className="user-log-in">
        ...
        <div className="user-log-in-container">
          ...
          <header className="user-log-in-container-header">
            ...
            <h2 className="user-log-in-container-header__name">Film Search</h2>
          </header>
...
const mapDispatchToProps = dispatch => ({
  getRequestToken: url => dispatch(actions.getRequestToken(url)),
  getGuestSession: url => dispatch(actions.getGuestSession(url)),
