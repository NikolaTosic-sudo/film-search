...
class SearchResults extends Component {
  ...
  componentDidMount() {
    this.props.searchData(`https://api.themoviedb.org/3/search/multi?api_key=${this.props.apiKey}&language=en-US&query=${this.props.match.params.id}&page=${this.state.page}&include_adult=false`);
  }
...
const mapDispatchToProps = dispatch => ({
  searchData: url => dispatch(actions.searchData(url)),
  postSearchResults: url => dispatch(actions.postSearchResults(url)),

  postMoviesUpcoming: url => dispatch(actions.postMoviesUpcoming(url)),
  postMoviesPopular: url => dispatch(actions.postMoviesPopular(url)),
  postMoviesNowPlaying: url => dispatch(actions.postMoviesNowPlaying(url)),
  postMoviesTopRated: url => dispatch(actions.postMoviesTopRated(url)),

  postTVAiringToday: url => dispatch(actions.postTVAiringToday(url)),
  postTVPopular: url => dispatch(actions.postTVPopular(url)),
  postTVOnTheAir: url => dispatch(actions.postTVOnTheAir(url)),
  postTVTopRated: url => dispatch(actions.postTVTopRated(url)),

  getPeoplePopular: url => dispatch(actions.getPeoplePopular(url)),
});
