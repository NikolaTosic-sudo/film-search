...
const mapDispatcherToProps = dispatch => ({
  postMDBConfig: url => dispatch(actions.postMDBConfig(url)),
  postMovieGenres: url => dispatch(actions.postMovieGenres(url)),
  postTVGenres: url => dispatch(actions.postTVGenres(url))
});
