...
const mapDispatchToProps = dispatch => ({
  getSession: (url, token) => dispatch(actions.getSession(url, token)),
  deleteSession: (url, sessionId) => dispatch(actions.deleteSession(url, sessionId)),
  toggleLogInStatus: status => dispatch(actions.toggleLogInStatus(status)),
  getUserDetails: url => dispatch(actions.getUserDetails(url)),
  getMovieFavorites: url => dispatch(actions.getMovieFavorites(url)),
  getTVFavorites: url => dispatch(actions.getTVFavorites(url)),
  getMoviesRated: url => dispatch(actions.getMoviesRated(url)),
  getTVRated: url => dispatch(actions.getTVRated(url)),
});
