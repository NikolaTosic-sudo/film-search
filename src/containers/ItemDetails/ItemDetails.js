...
const mapDispatchToProps = dispatch => ({
  getMovieDetails: url => dispatch(actions.getMovieDetails(url)),
  getMovieCredits: url => dispatch(actions.getMovieCredits(url)),
  getMovieTrailers: url => dispatch(actions.getMovieTrailers(url)),
  getMovieReviews: url => dispatch(actions.getMovieReviews(url)),

  getTVDetails: url => dispatch(actions.getTVDetails(url)),
  getTVCredits: url => dispatch(actions.getTVCredits(url)),
  getTVTrailers: url => dispatch(actions.getTVTrailers(url)),
  getTVReviews: url => dispatch(actions.getTVReviews(url)),

  getPeopleDetails: url => dispatch(actions.getPeopleDetails(url)),
  getPeopleCombinedCredits: url => dispatch(actions.getPeopleCombinedCredits(url)),
});
