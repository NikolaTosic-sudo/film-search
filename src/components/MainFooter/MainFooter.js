    ...
    <footer className="main-footer">
      ...
      <section className="main-footer-top">
        ...
        <header className="main-footer-top-header">
          <h2 className="main-footer-top-header__title wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1.2s">FILM SEARCH</h2>
          <nav className="main-footer-top-header-nav">
            <Link className="wow fadeInLeft" data-wow-delay=".7s" data-wow-duration="0.8s" to="/">Home</Link>
            <Link className="wow fadeInLeft" data-wow-delay=".9s" data-wow-duration="0.8s" to="/log-in">Profile</Link>
            <Link className="wow fadeInLeft" data-wow-delay="1.1s" data-wow-duration="0.8s" to="/discover">Discover</Link>
          </nav>
        </header>

        <div className="main-footer-top-item">
          <h3 className="main-footer-top-item__title">Portfolio:</h3>
          <p><a href="https://nikolatosic-sudo.github.io/portfolio/" target="_blank" rel="noopener noreferrer">https://nikolatosic-sudo.github.io/portfolio/</a></p>
        </div>
        ...
        <p className="main-footer-top-copyright">Code and design by <br/><a href="https://nikolatosic-sudo.github.io/portfolio/" target="_blank" rel="noopener noreferrer"><strong>Nikola Tosic</strong></a></p>

      </section>

      <section className="main-footer-bottom">

        <img className="main-footer-bottom-section-1 wow fadeInUp" data-wow-delay=".5s" data-wow-duration="0.8s" src={TMDBLogo}  alt="TMDB Logo" />
